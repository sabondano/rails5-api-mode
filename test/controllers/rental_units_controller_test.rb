...
class RentalUnitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental_unit" do
    assert_difference('RentalUnit.count') do
      post rental_units_url, params: { rental_unit: { address: @rental_unit.address, bathrooms: @rental_unit.bathrooms, price_cents: @rental_unit.price_cents, rooms: @rental_unit.rooms } }
    end
  ...
  test "should update rental_unit" do
    patch rental_unit_url(@rental_unit), params: { rental_unit: { address: @rental_unit.address, bathrooms: @rental_unit.bathrooms, price_cents: @rental_unit.price_cents, rooms: @rental_unit.rooms } }
    assert_response 200
  end
